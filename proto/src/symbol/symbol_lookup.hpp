...
/** Looks up a simple name among the members of the specified scope.
...
/** Searches for the simple name, starting from vantageScope and proceeding through its outer scopes,
 * finally doing a global search.
 */
